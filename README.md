...
Of the **843 participants** recruited, **811** met the ≥ 25% response rate criterion (≥ 11 valid assessments) and were included in the analysis (22,515 assessments).
...
```r
# Reproduce Tables 1–2, Figure 1, and Figure 2a–c (individual/socioeconomic heterogeneity):
...
| `figure1.pdf` | Figure 1 — violin + marginal prediction plots |
...
Of 843 recruited participants, the analysis applies a **≥ 25% response rate** threshold (≥ 11 valid EMA assessments), consistent with the 25th percentile of the completion distribution reported in Table S3. After this filter:
